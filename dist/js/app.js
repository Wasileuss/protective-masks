(() => {
    ...
    function formRating() {
        ...
        function formRatingInit(rating, ratingSize) {
            ...
            for (let index = 0; index < ratingSize; index++) {
                index === 0 ? ratingItems += `<div class="rating__items" aria-label="Rating box">` : null;
                ratingItems += `\n\t\t\t\t<label class="rating__item">\n\t\t\t\t\t<input class="rating__input" type="radio" name="rating" aria-label="Rating star" value="${index + 1}">\n\t\t\t\t</label>`;
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        const handleScroll = () => {
            ...
            if (scrollTop > lastScrollTop && scrollTop > headerHeight) header.style.top = `-${headerHeight}px`; else if (scrollTop === 0) header.style.backgroundColor = "transparent"; else {
                header.style.top = "0";
